...
CEQ_TCPClientHandler* CBackendServer::EQ_OnAcceptEx(CEQ_TcpClient* pNewClient)
{
...
void  CBackendServer::EQ_PostExceptionMessageEx(int nLevel, const char* szErrInfo, ...)
{
	va_list list;
...
bool  CBackendServer::AddPlayerClientInfo(void* pClient, int & nIndex)
{
...
bool  CBackendServer::DelPlayerClientInfo(void* pClient, int & nIndex)
{
...
void   CBackendServer::SendClientMsg(char* pDataInfo, long nDataLen, int nIndex, bool bClose)
{
...
void CBackendServer::SendGameServerMsg(char* pDataInfo, long nDataLen, void* pPacketHead)
{
