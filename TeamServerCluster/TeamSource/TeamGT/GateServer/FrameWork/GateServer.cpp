...
CEQ_TCPClientHandler* CGateServer::EQ_OnAcceptEx(CEQ_TcpClient* pNewClient)
{
...
void  CGateServer::EQ_PostExceptionMessageEx(int nLevel, const char* szErrInfo, ...)
{
	va_list list;
...
bool  CGateServer::AddPlayerClientInfo(void* pClient, int & nIndex)
{
...
bool  CGateServer::DelPlayerClientInfo(void* pClient, int & nIndex)
{
...
void   CGateServer::SendClientMsg(char* pDataInfo, long nDataLen, int nIndex, bool bClose)
{
...
void CGateServer::SendGameServerMsg(char* pDataInfo, long nDataLen, void* pPacketHead)
{
